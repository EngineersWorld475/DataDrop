          ...
          <div className="flex-1">
            ...
            >
              <div className="text-5xl">
                <span className="px-2 py-1 bg-gradient-to-r from-green-700 via-green-600 to-green-500 rounded-lg text-white">
                  Data
                </span>
                Drop
              </div>
            ...
            <p className="text-sm mt-5">
              ...
              seeks....” You can sign up with your email and password or with
              google
            </p>
          </div>
          {/* right side */}
